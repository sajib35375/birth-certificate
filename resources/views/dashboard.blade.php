    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                @php
                    $user_form_id = Auth::user()->form->id;
                       use App\Models\Approve; $form_app = Approve::where('form_id',$user_form_id)->first();
                @endphp

                @if( isset($form_app->id) )

                <a target="_blank" class="btn btn-warning btn-block" href="{{ route('pdf.download',Auth::id())}}">Download</a>
            ...
            <div class="col-md-9">
               <h1 style="color: #157ED2;"> Hi..{{ Auth::user()->name }}</h1>
               <div class="card">
